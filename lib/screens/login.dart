...
class _MyWidgetState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(body: webView(context),);
  }
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ElevatedButton.icon(
                              ...
                              icon: Image.asset('assets/images/google-logo.png', fit: BoxFit.contain, width: 30, height: 30,),
                              style: ElevatedButton.styleFrom(
                                  shape: RoundedRectangleBorder(
                                      side: BorderSide(color: Color(0xFF179C52)),
                                      borderRadius:
